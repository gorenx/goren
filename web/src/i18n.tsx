...
const simplifiedChinese = {
  ...
  'bound.description': '全局配置一次；每个用户会话会为每个已启用 Definition 建立独立后台 Bound。',
  'bound.close': '关闭',
  ...
  'bound.enabled': '已启用',
  'bound.disabled': '已停用',
  'bound.systemPrompt': '完整 System Prompt',
  'bound.provider': 'Provider（可选）',
  'bound.model': 'Model（可选）',
  'bound.maxTokens': 'Max tokens（可选）',
  'bound.maxDepth': '最大深度（可选）',
  'bound.toolMode': '工具限制',
  'bound.toolsInherit': '继承全部',
  'bound.toolsAllow': 'Allow 列表',
  'bound.toolsDeny': 'Deny 列表',
  'bound.toolsBoth': 'Allow 与 Deny',
  'bound.allowTools': '允许的工具（逗号分隔；空列表表示全部禁止）',
  'bound.denyTools': '禁止的工具（逗号分隔）',
  'bound.extensions': 'Extensions（按顺序，逗号分隔）',
  'bound.saving': '保存中…',
  'bound.create': '创建',
  'bound.replace': '保存新 revision',
...
const english = {
  ...
  'bound.title': 'Bound Definitions',
  'bound.description': 'Configure globally once; every user session gets one independent background Bound for each enabled Definition.',
  'bound.close': 'Close',
  ...
  'bound.systemPrompt': 'Complete system prompt',
  'bound.provider': 'Provider (optional)',
  'bound.model': 'Model (optional)',
  'bound.maxTokens': 'Max tokens (optional)',
  'bound.maxDepth': 'Max depth (optional)',
  'bound.toolMode': 'Tool restriction',
  'bound.toolsInherit': 'Inherit all',
  'bound.toolsAllow': 'Allow list',
  'bound.toolsDeny': 'Deny list',
  'bound.toolsBoth': 'Allow and deny',
  'bound.allowTools': 'Allowed tools (comma-separated; empty denies all)',
  'bound.denyTools': 'Denied tools (comma-separated)',
  'bound.extensions': 'Extensions (ordered, comma-separated)',
  'bound.saving': 'Saving…',
  'bound.create': 'Create',
  'bound.replace': 'Save new revision',
