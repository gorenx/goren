...
func TestAgentLoopConcreteStructOwnershipIsAllowedAndAcyclic(t *testing.T) {
	...
	allowed := map[string]struct{}{
		"AgentProvider -> ReactLoopAgent":           {},
		"AgentScope -> AgentProvider":               {},
		"Plugin -> ScopeSet":                        {},
		"Plugin -> StartupPlan":                     {},
		"Plugin -> registrationPlugin":              {},
		"Settings -> StartupAgent":                  {},
		"StartupPlan -> StartupAgent":               {},
		"agentScopePreparation -> AgentScope":       {},
		"agentScopePreparation -> ScopeSet":         {},
		"agentVariables -> namedAgentVariable":      {},
		"namedAgentVariable -> staticAgentVariable": {},
		"pluginEffect -> AgentScope":                {},
		"preparedAgent -> ReactLoopAgent":           {},
		"registrationPlugin -> Factory":             {},
		"sessionBinding -> ReactLoopAgent":          {},
			...
			if !strings.HasPrefix(filepath.Base(source.path), "plugin") {
				findings = append(
					...
					fileSet.Position(method.Name.Pos()).String()+": "+
						receiverTypeName(method.Recv.List[0].Type)+"."+
						method.Name.Name,
				)
			}
		}
