...
func (owner *Plugin) sendMessageDefinition() tools.ToolDefinition {
	return tools.ToolDefinition{
		...
		Executor: tools.ExecutorFunc(owner.sendMessage),
	}
}

func (owner *Plugin) sendMessage(
	rawArguments json.RawMessage,
	...
	messageID, followErr := owner.continuations.Followup(
		runContext.Context,
		parentAgent,
