...
func (owner *Plugin) interruptDefinition() tools.ToolDefinition {
	return tools.ToolDefinition{
		...
		Executor: tools.ExecutorFunc(owner.interrupt),
	}
}

func (owner *Plugin) interrupt(
	rawArguments json.RawMessage,
	...
	interruptErr := owner.continuations.Interrupt(
