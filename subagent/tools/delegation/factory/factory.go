...
// Factory constructs one SeedBuilder-bound delegation Tool Plugin while the
// configuration retains its canonical provider key.
type Factory struct{}
...
func (*Factory) Create(
	...
	return delegation.New(settings)
}
